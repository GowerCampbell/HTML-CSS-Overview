...
\<p\>92% of websites end up using Javascript, often refferred to as JS, and jQuery, the format jQueery is used within 63% of them. It is useful to write JavaScript or jQuery to build my own behaviors/OOP functions/classes.\</p\>
\</details\>
...
\<p\>Like CSS, Javascript is saved in an external file \<code\>.js\</code\> using the \<code\>\&lt;script\&gt;\</code\> element. I need to remember to place it before the closing \<code\>\&lt;/body\&gt;\</code\> tag so that the JavaScript is loaded last.\</p\>
\<p\>Remember: \<code\>\&lt;script src="script.js"\&gt;\&lt;/script\&gt;\</code\>\</p\>
\</details\>
